    ...
    <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
      <center>
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          ...
          <tr>
            <td class="free-text">
              Terima kasih telah mendaftar pada aplikasi On-food ! Semoga anda nyaman menggunakannya.
            </td>
          </tr>
          <tr>
            <td class="mini-block-container">
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%">
                      <tr>
                        <td style="padding-bottom: 20px;">
                          Berikut kode konfirmasi untuk login pada aplikasi On-food.
                        </td>
                      </tr>
                      <tr>
                        <td class="code-block">
                          ...
                          <table cellpadding="0" cellspacing="0" width="100%">
                            ...
                            <tr>
                              <td style="padding: 15px;">
                                <div><a class="button-width" href="http://"
                                style="background-color:#6F9EFF;border-radius:5px;color:#ffffff;display:inline-block;font-family:'Cabin', Helvetica, Arial, sans-serif;font-size:14px;font-weight:regular;line-height:45px;text-align:center;text-decoration:none; -webkit-text-size-adjust:none;mso-hide:all;">Download Sekarang !</a></div>
                              </td>
                            </tr>
                          </table>
                        </td>
